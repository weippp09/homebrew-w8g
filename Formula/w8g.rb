class W8g < Formula
  ...
  if Hardware::CPU.physical_cpu_arm64?
    ...
    url "https://github.com/weippp09/w8g/releases/download/v0.1.9/w8g-darwin-arm64.zip"
    sha256 "503b0eeea3be6ee5e8a1417c261c975b5d932ed29455483f0a0fe8fc34b254df"
  else
